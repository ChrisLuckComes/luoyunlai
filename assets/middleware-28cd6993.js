import{j as e,d as r,e as m}from"./index-52cacda3.js";import{U as a}from"./useMarkdown-2196212a.js";import{A as p}from"./Anchor-4d1d2fe9.js";import{A as s}from"./index-efd52f30.js";import"./pickAttrs-b8404ad1.js";const h="express是一个快速、灵活的轻量级Node.js Web应用程序开发框架，github star数量为59k。",u="相比express，koa没有绑定任何中间件，更轻量，按需引用中间件。koa2支持async/await，控制执行顺序和异常处理变得更容易。基于它编写中间件也更简单。它的github star数量为33k。",x=`\`\`\` js
app.use("/", indexRouter);
