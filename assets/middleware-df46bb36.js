import{j as e,d as r,e as m}from"./index-829bfc52.js";import{U as a}from"./useMarkdown-aabb00ed.js";import{A as p}from"./Anchor-23ca89a7.js";import{A as s}from"./index-7b3acfd8.js";import"./pickAttrs-2e0ba2ef.js";const h="express是一个快速、灵活的轻量级Node.js Web应用程序开发框架，github star数量为59k。",u="相比express，koa没有绑定任何中间件，更轻量，按需引用中间件。koa2支持async/await，控制执行顺序和异常处理变得更容易。基于它编写中间件也更简单。它的github star数量为33k。",x=`\`\`\` js
app.use("/", indexRouter);
