import{j as e,d as s}from"./index-57ee3021.js";import{A as x}from"./Anchor-bf78e4bb.js";import{U as t}from"./useMarkdown-858068ef.js";import"./index-1e12511c.js";const j="```ts\nconst express = require('express');\nconst app = express();\nconst port = 3000;\n\napp.listen(port, () => {\n    console.log(`Server is running on port ${port}`);\n});\n```",f="```ts\nconst { createApp } = require('vue');\nconst { renderToString } = require('@vue/server-renderer');\n```",y=`\`\`\`ts
