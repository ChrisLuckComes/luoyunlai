import{j as e,d as s}from"./index-efdda179.js";import{A as x}from"./Anchor-0e5acf0c.js";import{U as t}from"./useMarkdown-77fc54f3.js";import"./index-b85a3ae0.js";const j="```ts\nconst express = require('express');\nconst app = express();\nconst port = 3000;\n\napp.listen(port, () => {\n    console.log(`Server is running on port ${port}`);\n});\n```",f="```ts\nconst { createApp } = require('vue');\nconst { renderToString } = require('@vue/server-renderer');\n```",y=`\`\`\`ts
