import{j as e,d as s}from"./index-ad5eedbe.js";import{A as x}from"./Anchor-c966fdc9.js";import{U as t}from"./useMarkdown-b33dbcc0.js";import"./index-47679770.js";const j="```ts\nconst express = require('express');\nconst app = express();\nconst port = 3000;\n\napp.listen(port, () => {\n    console.log(`Server is running on port ${port}`);\n});\n```",f="```ts\nconst { createApp } = require('vue');\nconst { renderToString } = require('@vue/server-renderer');\n```",y=`\`\`\`ts
