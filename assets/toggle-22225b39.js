import{U as a}from"./useMarkdown-e5ed2f76.js";import{r,A as i,_ as p,j as o}from"./index-aeb01ca2.js";var c={icon:{tag:"svg",attrs:{viewBox:"0 0 1024 1024",focusable:"false"},children:[{tag:"path",attrs:{d:"M715.8 493.5L335 165.1c-14.2-12.2-35-1.2-35 18.5v656.8c0 19.7 20.8 30.7 35 18.5l380.8-328.4c10.9-9.4 10.9-27.6 0-37z"}}]},name:"caret-right",theme:"outlined"};const l=c;var x=function(t,n){return r.createElement(i,p(p({},t),{},{ref:n,icon:l}))},u=r.forwardRef(x);const f=u;function e(s,t){return{title:a({markdown:s}),content:a({markdown:t})}}const j="```ts\nexport type If<C extends boolean, T, F> = C extends true ? T : F;\n```",w="```ts\nexport type MyPick<T, K extends keyof T> = { [P in K]: T[P] };\n```",X="```ts\nexport type MyReadonly<T> = { readonly [K in keyof T]: T[K] };\n```",z=`\`\`\`ts
